defmodule BulmaExampleWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :bulma_example
  ...
  plug Plug.Static,
    ...
    from: :bulma_example,
    gzip: false,
    only: BulmaExampleWeb.static_paths()
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :bulma_example
  end
